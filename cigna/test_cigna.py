...
URLS = {
    ...
    "latest_updates_listing":
        "https://static.cigna.com/assets/chcp/resourceLibrary/coveragePolicies/latestUpdatesListing.html",
}
...
PAIN_KEYWORDS = [
    ...
    "si joint", "intracept", "basivertebral", "denervation"
]
